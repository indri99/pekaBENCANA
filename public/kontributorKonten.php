...
<div class="tabel">
  <table style="width:100%">
    ...
    <tr>
      <td><br>GUNUNG MERAPI MELETUS KEMBALI</td>
      <td><br>SLEMAN, YOGYAKARTA</td>
      <td><br>GUNUNG BERAPI</td>
      <td><br>DITERBITKAN</td>
      <td>
        <br><a href="#">LIHAT | </a>
        <a href="#">EDIT</a><br>
        <a href="#">HAPUS</a>
    ...
    <tr>
      <td><br>GEMPA 6,4 SR MENGGUNCANG BANDUNG</td>
      <td><br>BANDUNG, JAWA BARAT</td>
      <td><br>GEMPA</td>
      <td><br>MENUNGGU PERSETUJUAN</td>
      <td>
        <br><a href="#">LIHAT | </a>
        <a href="#">EDIT</a><br>
        <a href="#">HAPUS</a>
